...
<head>
    ...
    <title>::DTP'sPhone - Điện Thoại, Phụ Kiện </title>
    ...
    <script>
      paypal.Buttons({
        ...
        onApprove: function(data, actions) {
            ...
            window.location.replace('http://localhost:8080/shopphone/index.php?act=checkout&xuli=execute&method=paypal&id=<?=$_GET['MaHD']?>&transId='+paymentId);
